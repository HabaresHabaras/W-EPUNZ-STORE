...
let client_id = 'TvVszVY88XHjC713PmIfUAGENP4qzMPoFGv8fJgwtJ';
...
export const CreateCustomer = customerInformation => Moltin.Customers.Create(customerInformation);

export const GetCustomer = (email, password) => Moltin.Customers.Token(email, password);
